...
class RedisTaskKeys:
    ...
    RTQ_QUEUE_LIST = {
        ...
        # qy wechat
        "QY_CAL": {"s": "service.wechat.callback.qy_callback_service@QyCallbackService.qy_push_handler", "n": 1, "t": "vp"},
        "QY_GIT": {"s": "service.gitee.gitee_webhook_service@GiteeWebhookService.gitee_push_handler", "n": 1, "t": "vp"},
        # gpl batch
