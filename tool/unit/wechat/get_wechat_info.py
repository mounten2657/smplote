...
class GetWechatInfo:
    ...
    @staticmethod
    def get_user_list(wxid: str, db_config: dict, wxid_dir: str):
        """
        获取并保存用户列表
        :param wxid: wxid，自己查看本地微信文件夹获取
    ...
    @staticmethod
    def get_chat_list(wxid: str, db_config: dict, wxid_dir: str):
        """
        获取并保存聊天列表
        :param wxid: wxid，自己查看本地微信文件夹获取
        :param db_config:  数据库配置，来自 config/db.json
    ...
    @staticmethod
    def get_session_list(wxid: str, db_config: dict, wxid_dir: str):
        """
        获取并保存用户列表
        :param wxid: wxid，自己查看本地微信文件夹获取
        :param db_config:  数据库配置，来自 config/db.json
    ...
    @staticmethod
    def get_room_list(wxid: str, db_config: dict, wxid_dir: str):
        """
        获取并保存用户列表
        :param wxid: wxid，自己查看本地微信文件夹获取
        :param db_config:  数据库配置，来自 config/db.json
